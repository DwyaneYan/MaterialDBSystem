...
namespace HanGang.MaterialSystem.Entities
{
    ...
    /// 试验数据
    /// </summary>
    public class MaterialTrialData : FullAuditedAggregateRoot<Guid>
    {
        #region 关联材料试验
        ...
        /// 静态拉伸试验数据明细2
        /// </summary>
        public virtual HashSet<StaticTensionDataDetailRequirement> StaticTensionDataDetailRequirements { get; set; } = new HashSet<StaticTensionDataDetailRequirement>();
