        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CyclicStressRatio = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestTarget = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtensometerGaugeDistance = table.Column<decimal>(nullable: true),
                    SurfaceQuality = table.Column<string>(nullable: true),
                    CyclicStrainRatio = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointAdhesion = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    PaintingDataDetailId = table.Column<Guid>(nullable: true),
                    PointThick = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    PaintingDataDetailId = table.Column<Guid>(nullable: true),
                    PointHardness = table.Column<decimal>(nullable: true),
                    Remark = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rz = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PunchFilletRadius = table.Column<decimal>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "Material_DentResistanceDataDetailLimitStrains",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    ExtraProperties = table.Column<string>(nullable: true),
                    ...
                    DeleterId = table.Column<Guid>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    DentResistanceDataDetailId = table.Column<Guid>(nullable: true),
                    MainStrain = table.Column<decimal>(nullable: true),
                    SecondaryStrain = table.Column<decimal>(nullable: true),
                    Remark = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Material_DentResistanceDataDetailLimitStrains", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Material_DentResistanceDataDetailLimitStrains_Material_Dent~",
                        column: x => x.DentResistanceDataDetailId,
                        principalTable: "Material_DentResistanceDataDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Material_DentResistanceDataDetailLimitStrains_Material_Seco~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Material_DentResistanceDataDetailLimitStrains_DentResistanc~",
                table: "Material_DentResistanceDataDetailLimitStrains",
                column: "DentResistanceDataDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_Material_DentResistanceDataDetailLimitStrains_SecondaryWork~",
                table: "Material_DentResistanceDataDetailLimitStrains",
